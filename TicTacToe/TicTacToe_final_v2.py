                    ...
                    if check_coordinates(x_axis, y_axis):
                        ...
                        if check_cells(x_axis, y_axis, cells):
                            ...
                            if turn == "X":
                                ...
                                print(c)
                                if c <= 9:
                                    if check_board(board) == "Game not finished":

                                        continue
                                    elif check_board(board) == "Impossible":
                                        break
                                    elif check_board(board) == "X wins":
                                        break
                                    elif check_board(board) == "Draw":
                                        break
                                # else:
                                #     print("Draw")
                                #     break
